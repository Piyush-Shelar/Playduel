...
//           </div>
//           <div>
//             <div className="text-sm font-bold tracking-wide">SkillDuels</div>
//             <div className="text-[11px] text-white/40">Competitive Learning</div>
//           </div>
//         </div>
...
//           <button
//             onClick={() => { setAuthMode("signin"); setLoginOpen(true); }}
...
//               <button onClick={() => setMobileOpen(false)} className="text-white/50 hover:text-white">✕</button>
//             </div>
